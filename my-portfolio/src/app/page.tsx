      ...
      <div className="mb-32 flex text-center lg:mb-0 lg:grid-cols-4 lg:text-left bottom-0 pt-40">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            You can understand about my background. Are you curious about who I am and what I am like?
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Let me explain what kind of technology I have!
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Let me tell you about my private Interests.
          </p>
        </a>
